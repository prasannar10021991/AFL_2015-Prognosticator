...
#portadelaide = "aflportadelaide","aflport", "aflpower","pafc","portadelaidefootball","portadelaidefc","portadelaide_fc","goportadelaide","gopower","portadelaideftw","powersftw","portadelaiderule","powersrule","portadelaidesuck","powerssuck" 
...
for u in playerlist(westcoastpl,100000):
    plist.append(u)    
    
for u in playerlist(brisblionspl,100000):
    plist.append(u)    
    
for u in playerlist(goldcoastpl,100000):
    plist.append(u)    
    
for u in playerlist(hawkspl,100000):
    plist.append(u)    
    
for u in playerlist(adelaidepl,100000):
    plist.append(u)    
    
for u in playerlist(richmondtigerspl,100000):
    plist.append(u)    
    
for u in playerlist(collingwoodpl,100000):
    plist.append(u)    
    
for u in playerlist(carltonpl,100000):
    plist.append(u)    
    
for u in playerlist(stkildapl,100000):
    plist.append(u)    
    
for u in playerlist(fremantlepl,100000):
    plist.append(u)    
    
for u in playerlist(gwsgiantspl,100000):
    plist.append(u)    
    
for u in playerlist(westernbullpl,100000):
    plist.append(u)    
    
for u in playerlist(essendonpl,100000):
    plist.append(u)    
    
for u in playerlist(sydneyswanspl,100000):
    plist.append(u)    
    
for u in playerlist(geelongpl,100000):
    plist.append(u)    
    
for u in playerlist(melbdemonspl,100000):
    plist.append(u)    
    
for u in playerlist(northmelbournepl,100000):
    plist.append(u)    
...
print playerrec
oldDet = ["afl","#AFL"]    
must  =["adelaide","crow","portadelaide","power","melbourne","demon","dee","north","kanga","western","dog","gws","giant","sydney","swan","essendon","don","bomber","geelong","cat","brisbane","lion","collingwood","fremantle","docker",'freo',"pie","goldcoast","sun","westcoast","eagle","carlton","blue","richmond","tiger","footscray","hawthorn","hawk","kilda","saint"]
        ...
        try:
            ...
            for tweet in new_tweets:
                try:
                    ...
                    if((("April" in date) or ("May" in date)) and ("2015" in date)):
                        text = json_val["text"]
                        for x in must:
                            if x in text:
                                ...
                                tweetData = open('oldTweets.csv','a')
            ...
            if(tweetCount>5000):
                ...
                tweetstats = open('STATS_prev.csv','a')
                
                if(savefp != str(fplist)):
                    savefp = str(fplist)
                    #print(str(get_indentifier_name_missing_function(collingwoodvscarlton)))
                    tweetstats.write('playerStats :')
                    tweetstats.write('\n')
