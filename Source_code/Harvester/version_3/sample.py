...
northmelbvshawthorn = ["aflnorthhawks","aflhawksnorth","aflkangarooshawks","aflhawkskangaroos","aflhawks","aflkangaroos","thehawks","thekangaroos","northmelbournefootballclub","northmelbournefc","northmelbourne_fc","gokangaroo","gonorthmelbourne","gonorth","kangaroosftw","northftw","northmelbourneftw","kangaroosrule","northmelbournerule","hawthornhawks","hawthornfootballclub","hawthornfc","hawthorn_fc","gohawks","gohawthorn","hawksftw","hawthornftw","hawksrule","hawthornrule","hawthornsuck","hawkssuck","northmelbornesuck","kangaroossuck"]
westcoastvsgws = ["afleaglesgiants","aflgiantseagles","aflgiants","afleagles","aflfreaterwesternsydney","aflwestcoasteagles","aflwestcoast","aflgwsgiants","gwsgiants","thegiants","greaterwesternsydney","westcoasteagles","gogiants","gogwsgiants","goeagles","gowestcoast","giantsftw","eaglesftw","westcoastftw","westcoastrule","eaglesrule","giantsrule","gwsrule","eaglessuck","giantssuck","westcoastsuck","gwssuck"]
melbournevsfremantle = ["aflfreodees","afldeesfreo","aflfreosdee","afldeefreos","aflfreo","afldemon","afldee","aflfremantle","aflmelbournefootballclub","melbournefootballclub",""]
stkildavsessendon = []
adelaidevsportadelaide = []

#collingwood = "collingwood_fc","collingwoodfc","aflpies","aflmagpies","aflcollingwood","collingwoodfootball","collingwoodpies","gocollingwood","collingwoodsuck","magpiesrule","magpies","gomagpies","magpiessuck","piessuck","gopies","magpiesftw","piesftw","piesrule","thepies"
...
#northmelb = "aflkanga","aflkangaroos","northmelbournefootball","northmelbournefc","northmelbourne_fc","gonorthmelbourne","gonorth","northftw","northmelbourneftw","northmelbournerule","northmelbornesuck","thekangaroos","gokangaroo","kangaroosftw","kangaroosrule","kangaroossuck"
...
#hawthorn = "aflhawks","hawthornhawks","hawthornfootball","hawthornfc","hawthorn_fc","gohawks","gohawthorn","hawksftw","thehawks","hawthornftw","hawksrule","hawthornrule","hawthornsuck","hawkssuck"
...
#gwsgiants = "aflgiants","giantsfc","giants_fc","aflgwsgiants","gwsgiants","thegiants","greaterwesternsydney","gogiants","gogwsgiants","giantsftw","giantsrule","gwsrule","giantssuck","gwssuck"
...
sydneyvswesternbulldogs1 = []            
for x in combos(sydneyvswesternbulldogs,1000000): 
    sydneyvswesternbulldogs1.append(x)



for u in playerlist(sydneyswanspl,100000):
    plist.append(u)

for u in playerlist(westernbullpl,100000):
    plist.append(u)    
    

    
print sydneyvswesternbulldogs1     
...
while tweetCount < maxTweets: 
    ...
    for word in sydneyvswesternbulldogs1:
        searchQuery = word
        print word
        hcount =0
        recent=""
        ...
        try:
            ...
            for tweet in new_tweets:
                try:
                    ...
                    if(("May 02" in date) or ("May 03" in date)):
                        text = json_val["text"]
                        ...
                        if(maxhcount<hcount and recent != word):
                            ...
                            ftag.append(word)
                            print ftag
                        if((word.find("sydney")>=0) or (word.find("swan")>=0)):
                            if((text.find("sydney")>=0) or (text.find("swan")>=0)):
                                if(rtcount>maxrt1):
                                    maxrt1 = rtcount1
                                    mostrt1 = _id
                        ...
                        if((word.find("footscray")>=0) or (word.find("dog")>=0)):
                            if((text.find("footscray")>=0) or (text.find("dog")>=0)):
                                if(rtcount>maxrt2):
                                    maxrt2 = rtcount2
                                    mostrt2 = _id
                        ...
                        #db.save(doc)
                        tweetData = open('sydneyvswesternbulldogsTweets.csv','a')
            ...
            if(tweetCount>3500):
                ...
                tweetstats = open('STATS.csv','a')
                
                if((rtcount1-savert1 > 200) or (rtcount2-savert2 >200) or (fcount1-savefc1 >200) or (fcount2-savefc2 > 200) or savewt1 != winteam1 or savewt2 != winteam2 or saveft != str(ftag) or savefl != str(flist) or savemr1 != mostrt1 or savemr2 != mostrt2 or savefp != str(fplist)):
                    savert1 = rtcount1
                    savert2 = rtcount2
                    savefc1 = fcount1
                    savefc2 = fcount2
                    ...
                    tweetstats.write('sydneyswans vs westernbulldogs')
